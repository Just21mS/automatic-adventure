$(`<img src="sico/1628480234674.gif" 
	...
	$(`<style>
	.uzr.fl.corner.borderg{margin-bottom:0!important}button.ssss.btn.fr.btn-warning.fa.fa-paint-brush{display:none}.hand.nosel.fl.uzr.border{border-radius:5px!important}textarea.form-control.borderg.primaryborder.corner.fr.ulikeins{font-size:15px!important;color:#5d4037;padding:4px!important}textarea.form-control.borderg.primaryborder.corner.fr.u-topic{font-size:15px!important;color:#5d4037;padding:4px!important}#des0{background-color:#5d4037}div#tlogins ::-webkit-scrollbar{width:0;height:10px}div#tlogins ::-webkit-scrollbar-button{width:5px;height:5px}div#tlogins ::-webkit-scrollbar-corner{background:0 0}div#tlogins ::-webkit-scrollbar-thumb{background:#5d4037;border:71px #fff;border-radius:31px;background-image:-webkit-linear-gradient(45deg,rgba(255,255,255,.2) 25%,transparent 25%,transparent 50%,rgba(255,255,255,.2) 50%,rgba(255,255,255,.2) 75%,transparent 75%,transparent)!important}div#tlogins ::-webkit-scrollbar-track{background:#fff;border:65px #fff;border-radius:34px}
	</style>
	`).insertBefore('body');
