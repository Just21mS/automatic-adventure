$(`<img src="https://r7shq.com/sico/1628480234674.gif" 
	...
	$('.break.light').css({"background-image":"url(sico/1643420487718.png)"});
  ...
  $(`<a href="http://www.r7shq.net/" target="_blank" id="as0" class="border">ستايل شات 4 </a>`).insertBefore('a.fl.fa.fa-ban.btn.ui-corner-all.ui-shadow.ui-btn.ui-btn-inline.umute.borderg'),
	...
	$(`<a href="http://r7shq.net/" target="_blank" id="as0" class="border">الموقع الرئيسي</a>`).insertBefore('a.fl.fa.fa-ban.btn.ui-corner-all.ui-shadow.ui-btn.ui-btn-inline.umute.borderg'),
